...
export default function HeroSection() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-indigo-900 to-slate-900 rounded-2xl p-8 sm:p-10 shadow-lg text-white mb-6 border border-slate-700">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="max-w-2xl space-y-4">
          <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-md text-xs font-medium text-indigo-100 select-none">
            <MapPin size={12} className="text-indigo-400" />
            <span>Jalandhar Electronics Market</span>
          </div>
          
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-white to-indigo-200">
        ...
        <div className="flex items-center gap-3 sm:gap-4 shrink-0 overflow-x-auto pb-2 md:pb-0 custom-scrollbar">
          ...
          <div className="flex flex-col p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md select-none">
            <span className="flex items-center text-slate-400 text-xs mb-1">
              <Sparkles size={12} className="mr-1 text-indigo-400" /> Data Freshness
            </span>
