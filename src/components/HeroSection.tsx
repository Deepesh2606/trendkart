...
export default function HeroSection() {
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-stone-800 to-stone-900 rounded-2xl p-8 sm:p-10 shadow-lg text-white mb-6 border border-stone-700">
      {/* Decorative background elements */}
      <div className="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 rounded-full bg-stone-300/20 blur-3xl mix-blend-screen pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 rounded-full bg-stone-500/10 blur-3xl mix-blend-screen pointer-events-none"></div>
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="flex items-center gap-3 sm:gap-4 shrink-0 overflow-x-auto pb-2 md:pb-0 custom-scrollbar">
          <div className="flex flex-col p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md select-none">
            <span className="flex items-center text-stone-400 text-xs mb-1">
          ...
          <div className="flex flex-col p-3 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md select-none">
            <span className="flex items-center text-stone-400 text-xs mb-1">
              <Sparkles size={12} className="mr-1 text-stone-100" /> Data Freshness
            </span>
