            ...
            {loading ? (
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  ...
                  <Bar dataKey="marketItems" name="Market Trend" fill="var(--chart-market)" radius={[4, 4, 0, 0]} barSize={20} />
                  <Bar dataKey="shopItems" name="Your Stock" fill="var(--chart-stock)" radius={[4, 4, 0, 0]} barSize={20} />
                </BarChart>
              </ResponsiveContainer>
            )}
          </div>
