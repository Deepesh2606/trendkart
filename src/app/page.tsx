...
import { ArrowRight, Check, Heart, Menu, Search, ShoppingBag, Star, X } from 'lucide-react'
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="border-b border-border bg-foreground text-background px-4 py-2 text-center text-xs font-semibold tracking-wide">
      ...
      <section id="top" className="mx-auto grid max-w-7xl gap-8 border-b border-border px-5 pb-14 pt-10 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:px-8 lg:pt-16">
        <div>
          <div className="mb-6 text-xs font-black uppercase tracking-widest text-primary">Weekly edit · practical upgrades</div>
